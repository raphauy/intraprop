...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="filtrar inmo..."
              value={(table.getColumn("inmo")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("inmo")?.setFilterValue(event.target.value)}                
          />
