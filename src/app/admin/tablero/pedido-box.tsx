                ...
                <div className="flex gap-2">
                    ...
                    <div className="flex flex-col justify-between flex-1 pl-2 border-l gap-7">
                        ...
                        <div className="flex justify-between">
                            ...
                            {pedido.status !== "paused" && <p className="font-bold">{isExitoso ? "exitoso" : pedido.status === "pending" ? "pendiente" : (pedido.status === "no_coincidences" || cantCoincidencias === 0) ? "sin coincidencias" : "procesando..."}</p>}
                            {
